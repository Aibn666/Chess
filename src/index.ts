...
import Piece from "./clases/piezas";
...
for(let i = 0; i < 2; i+=1){
    ...
    board.initPlacePiece(1, i * 7, new Piece(pieces.knight,i ? pieceTheme.light : pieceTheme.dark));
    board.initPlacePiece(6, i * 7, new Piece(pieces.knight,i ? pieceTheme.light : pieceTheme.dark));
    board.initPlacePiece(2, i * 7, new Piece(pieces.bishop,i ? pieceTheme.light : pieceTheme.dark));
    board.initPlacePiece(5, i * 7, new Piece(pieces.bishop,i ? pieceTheme.light : pieceTheme.dark));
